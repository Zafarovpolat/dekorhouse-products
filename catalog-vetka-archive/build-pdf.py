...
async def render_chunk(pw, first, last, out_path):
    ...
    await page.goto(f"http://127.0.0.1:{PORT}/catalog-vetka-archive/index.html", wait_until="domcontentloaded", timeout=60_000)
...
async def main(out_path):
    ...
    try:
        ...
        async with async_playwright() as pw:
            ...
            p = await b.new_page()
            await p.goto(f"http://127.0.0.1:{PORT}/catalog-vetka-archive/index.html", wait_until="domcontentloaded", timeout=60_000)
